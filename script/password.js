function generate() {
    if (health < 1) {
        ...
        event2_main.textContent = "Но мы пойдём другим путём";
        event2_name.textContent = "У Вас не получиться перехитрить систему...";
        ...
        event2_main.textContent = "ваш пароль:";
